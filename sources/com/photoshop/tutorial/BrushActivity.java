...
public class BrushActivity extends AppCompatActivity {
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BrushActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Brush");
        this.webview1.loadUrl("file:///android_res/raw/brush");
