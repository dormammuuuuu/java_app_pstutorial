...
public class PenssubActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.penssub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PenssubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        ...
        this.webview1.loadUrl("file:///android_res/raw/pen");
