...
public class RectangularsubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private LinearLayout linear1;
    private String rmarquee = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.rectangularsub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                RectangularsubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Rectangular Marquee Tool");
        this.webview1.loadUrl("file:///android_res/raw/rmarquee");
