...
public class PlassosubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private LinearLayout linear1;
    private String plasso = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.plassosub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PlassosubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Polygonal Lasso Tool");
        this.webview1.loadUrl("file:///android_res/raw/plasso");
