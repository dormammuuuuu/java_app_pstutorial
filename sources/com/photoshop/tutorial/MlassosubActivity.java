...
public class MlassosubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private LinearLayout linear1;
    private String mlasso = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.mlassosub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MlassosubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Magnetic Lasso Tool");
        this.webview1.loadUrl("file:///android_res/raw/mlasso");
