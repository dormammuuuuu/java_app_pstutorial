...
public class ArthistorybrushActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private String ahbrush = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.arthistorybrush);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ArthistorybrushActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Art History Brush");
        this.webview1.loadUrl("file:///android_res/raw/arthistorybrush");
