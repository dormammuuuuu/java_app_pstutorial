...
public class BlursubActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.blursub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlursubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        ...
        this.webview1.loadUrl("file:///android_res/raw/blur");
