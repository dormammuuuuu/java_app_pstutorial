...
public class EllipticalsubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private String emarquee = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.ellipticalsub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EllipticalsubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Elliptical Marquee Tool");
        this.webview1.loadUrl("file:///android_res/raw/emarquee");
