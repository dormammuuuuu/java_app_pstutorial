...
public class ScolumnsubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private LinearLayout linear1;
    private String scmarquee = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.scolumnsub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ScolumnsubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Single Column Marquee Tool");
        this.webview1.loadUrl("file:///android_res/raw/scmarquee");
