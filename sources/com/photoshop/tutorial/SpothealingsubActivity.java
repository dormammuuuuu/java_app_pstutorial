...
public class SpothealingsubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private LinearLayout linear1;
    private String spothealing = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.spothealingsub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SpothealingsubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Spot Healing Brush");
        this.webview1.loadUrl("file:///android_res/raw/spothealingtool");
