...
public class DodgesubActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.dodgesub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DodgesubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        ...
        this.webview1.loadUrl("file:///android_res/raw/dodge");
