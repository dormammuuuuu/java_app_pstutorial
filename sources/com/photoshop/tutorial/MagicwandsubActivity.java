...
public class MagicwandsubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private LinearLayout linear1;
    private String mwselect = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.magicwandsub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MagicwandsubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Magic Wand Tool");
        this.webview1.loadUrl("file:///android_res/raw/mwselection");
