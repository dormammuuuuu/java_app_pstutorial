...
public class HistorybrushActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private String hbrush = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.historybrush);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HistorybrushActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "History Brush");
        this.webview1.loadUrl("file:///android_res/raw/historybrush");
