...
public class ContentawaresubActivity extends AppCompatActivity {
    private Toolbar _toolbar;
    private String contentaware = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.contentawaresub);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this._toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ContentawaresubActivity.this.onBackPressed();
            }
        });
    ...
    private void initializeLogic() {
        getSupportActionBar().setTitle((CharSequence) "Content-Aware Move Tool");
        this.webview1.loadUrl("file:///android_res/raw/contentaware");
